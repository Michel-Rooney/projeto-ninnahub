...
class Espacos(models.Model):
    ...
    imagem2 = models.ImageField(upload_to='fotos/espacos', blank=True)
    imagem3 = models.ImageField(upload_to='fotos/espacos', blank=True)
    imagem4 = models.ImageField(upload_to='fotos/espacos', blank=True)
